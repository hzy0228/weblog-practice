...
-- ----------------------------
INSERT INTO `t_article` VALUES (6, '测试标题', 'https://ts3.tc.mm.bing.net/th/id/OIP-C.7GLMYPqMlt2LgkbPsOnDIAAAAA?w=251&h=248&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2', '测试摘要', '2025-05-28 15:19:53', '2025-05-28 15:19:53', 0, 15);
INSERT INTO `t_article` VALUES (9, '测试标题', 'https://ts3.tc.mm.bing.net/th/id/OIP-C.7GLMYPqMlt2LgkbPsOnDIAAAAA?w=251&h=248&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2', '测试摘要', '2025-05-28 15:20:06', '2025-05-28 15:24:41', 0, 10);
...
-- ----------------------------
INSERT INTO `t_article_category_rel` VALUES (6, 6, 3);
INSERT INTO `t_article_category_rel` VALUES (8, 9, 7);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章对应标签关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_article_tag_rel
-- ----------------------------
INSERT INTO `t_article_tag_rel` VALUES (9, 6, 7);
INSERT INTO `t_article_tag_rel` VALUES (10, 6, 8);
INSERT INTO `t_article_tag_rel` VALUES (13, 9, 7);
INSERT INTO `t_article_tag_rel` VALUES (14, 9, 8);
INSERT INTO `t_article_tag_rel` VALUES (15, 9, 9);
...
-- ----------------------------
INSERT INTO `t_blog_settings` VALUES (1, 'https://ts3.tc.mm.bing.net/th/id/OIP-C.7GLMYPqMlt2LgkbPsOnDIAAAAA?w=251&h=248&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2', 'hdy的博客', 'hdy', '平安喜乐', 'https://ts3.tc.mm.bing.net/th/id/OIP-C.7GLMYPqMlt2LgkbPsOnDIAAAAA?w=251&h=248&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2', '', '', '', '');
...
CREATE TABLE `t_category`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章分类表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_category
-- ----------------------------
INSERT INTO `t_category` VALUES (1, 'java', '2025-05-09 16:24:34', '2025-05-09 16:24:34', 0);
INSERT INTO `t_category` VALUES (3, 'python', '2025-05-12 14:58:52', '2025-05-12 14:58:52', 0);
INSERT INTO `t_category` VALUES (4, 'C', '2025-05-12 14:59:06', '2025-05-12 14:59:06', 0);
INSERT INTO `t_category` VALUES (7, 'C++', '2025-05-13 09:24:50', '2025-05-13 09:24:50', 0);
INSERT INTO `t_category` VALUES (8, 'Go', '2025-05-13 09:24:55', '2025-05-13 09:24:55', 0);
INSERT INTO `t_category` VALUES (9, 'dsadas', '2025-05-13 12:40:12', '2025-05-13 12:40:12', 0);
...
CREATE TABLE `t_tag`  (
  ...
  UNIQUE INDEX `uk_name`(`name` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章标签表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_tag
-- ----------------------------
INSERT INTO `t_tag` VALUES (2, '2', '2025-05-14 11:06:21', '2025-05-14 11:06:21', 0);
INSERT INTO `t_tag` VALUES (3, '3', '2025-05-14 11:06:21', '2025-05-14 11:06:21', 0);
INSERT INTO `t_tag` VALUES (7, '标签1', '2025-05-14 11:08:12', '2025-05-14 11:08:12', 0);
INSERT INTO `t_tag` VALUES (8, '标签2', '2025-05-14 11:08:12', '2025-05-14 11:08:12', 0);
INSERT INTO `t_tag` VALUES (9, '标签3', '2025-05-14 11:08:12', '2025-05-14 11:08:12', 0);
INSERT INTO `t_tag` VALUES (15, 'Java', '2025-05-21 11:14:34', '2025-05-21 11:14:34', 0);
INSERT INTO `t_tag` VALUES (16, '工具', '2025-05-21 11:14:34', '2025-05-21 11:14:34', 0);
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'hdy', '$2a$10$eXjXwhpE8.bAf9svW5HI4.ADVbLhSANDnlPzMLBazJBg4QWmejyJO', '2025-03-28 14:09:13', '2025-05-13 12:45:54', 0);
INSERT INTO `t_user` VALUES (2, 'admin', '$2a$10$fjw6Sfsl4foBjR4pRK2Ba.rSqGJh/51bY4GZMxAJOTX/eb2ClQFJy', '2025-04-10 10:21:14', '2025-04-10 10:21:14', 0);
INSERT INTO `t_user` VALUES (3, 'test', '$2a$10$2xhGer8LLp3Ah2sXNomWu.HbkN5cnl7p4/GWZJWaTB9vNAe1rZMwu', '2025-04-10 10:21:45', '2025-05-09 11:46:32', 0);
...
INSERT INTO `t_user_role` VALUES (3, 'hdy', 'ROLE_ADMIN', '2025-05-09 11:43:27');
